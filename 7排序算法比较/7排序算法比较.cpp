...
//	end = clock();
//	cout << "直接插入排序，共经过" << comp << "次比较，" << move << "次移动，用时"<<end-start<<"ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//	
//
...
//	end = clock();
//	cout << "折半插入排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "希尔排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "冒泡排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "快速排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "选择排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "二路归并排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	reset(comp, move, a, b);
...
//	end = clock();
//	cout << "堆排序，共经过" << comp << "次比较，" << move << "次移动，用时" << end - start << "ms" << endl;
//	check(b, maxn);
//	show(b, maxn);
//
//	delete[] a;
